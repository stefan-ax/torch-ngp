                ...
                with dpg.collapsing_header(label="Train", default_open=True):
                    ...
                    with dpg.group(horizontal=True):
                        ...
                        def callback_mesh(sender, app_data):
                            self.trainer.save_mesh(resolution=dpg.get_value("_resolution_mesh"),
                                                   threshold=dpg.get_value("_threshold_mesh"))
                    ...
                    with dpg.group(horizontal=True):
                        dpg.add_slider_int(label="Resolution", min_value=128, max_value=2048, tag="_resolution_mesh",
                                           default_value=256)

                    with dpg.group(horizontal=True):
                        dpg.add_slider_int(label="Threshold", min_value=0, max_value=20, tag="_threshold_mesh",
                                           default_value=10)
